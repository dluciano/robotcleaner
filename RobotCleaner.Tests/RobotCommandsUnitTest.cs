...
namespace RobotCleaner.Tests
{
    public class RobotCommandsUnitTest
    {
        ...
        [Fact]
        public void When_moving_2_step_to_N_and_1_to_S_then_three_rooms_should_be_cleaned()
        {
            var robot = new Robot();
            var commands = new Queue<CommandRequest>();
        ...
        [Fact]
        public void When_moving_2_step_to_N__1_to_S_and_1_to_E_then_four_rooms_should_be_cleaned()
        {
            var robot = new Robot();
            var commands = new Queue<CommandRequest>();
            commands.Enqueue(new CommandRequest(Direction.N, 2));
